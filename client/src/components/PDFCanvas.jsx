          ...
          >
            {Array.from(new Array(numPages || 0), (_, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`relative mx-auto my-4 w-fit rounded-lg border border-gray-300 bg-white p-4 shadow-lg transition-all duration-200 ${
                    isDocumentFinalized ? "cursor-default" : "cursor-crosshair hover:ring-2 hover:ring-blue-200"
                  }`}
                  onClick={(event) => !isDocumentFinalized && onPageClick(pageNumber, event)}
