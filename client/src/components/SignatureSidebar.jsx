                    ...
                    <div className="flex-1 overflow-y-auto px-6 py-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <p className="mt-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-base text-gray-800"
                                    style={{
                                        fontFamily: getFontPreviewFamily(signatureForm.fontFamily),
                                        fontStyle: String(signatureForm.fontFamily || "").toLowerCase().includes("italic") || String(signatureForm.fontFamily || "").toLowerCase().includes("oblique") ? "italic" : "normal",
